...
DOCUMENTATION BEING WORKING OUT !!!!!!!!!!!!!!!!

## Your new helper, AzResourceGraphPS
I am really happy to announce my new Powershell module, **AzResourceGraphPS**. This module can ease the steps, if you want to extract data from Azure 
